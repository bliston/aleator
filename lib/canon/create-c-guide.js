var cMachine = require('./c-machine.js')
 ...
 */
var createCguide = function (key, maxRange, maxLength) {
  var guide = cMachine.createGuide(key || 'C major')
